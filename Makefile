...
.PHONY: all vim zsh others reset fonts brew check_brew install_brew symlink vim_symlink zsh_symlink agents help gitignore
...
zsh: check_brew gitignore zsh_symlink agents ## Install Zsh config + packages
