...
local kind_icons = {
  Text = Icons.file_text_fill,
  Method = Icons.cube,
  Function = Icons.func,
  Constructor = Icons.constructor,
  Field = Icons.tag_plus,
  Variable = Icons.variable,
  Class = Icons.class,
  Interface = Icons.interface,
  Module = Icons.package_closed,
  Property = Icons.tag_plus,
  Unit = Icons.ruler,
  Value = Icons.numbers,
  Enum = Icons.combine,
  EnumMember = Icons.combine,
  Keyword = Icons.key,
  Snippet = Icons.snippet,
  Color = Icons.palette,
  File = Icons.file_text_fill,
  Reference = Icons.export,
  Folder = Icons.directory,
  Constant = Icons.pi,
  Struct = Icons.file_tree,
  Event = Icons.thunder,
  Operator = Icons.operator,
  TypeParameter = Icons.text,
  Copilot = Icons.copilot_enabled,
  Codeium = Icons.windsurf_enabled,
}
